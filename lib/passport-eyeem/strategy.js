...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://www.eyeem.com/oauth/authorize';
  options.tokenURL = options.tokenURL || 'http://api.eyeem.com/v2/oauth/token';
...
Strategy.prototype.userProfile = function(accessToken, done) {
    ...
    this._oauth2.get('http://api.eyeem.com/v2/users/me', accessToken, function (err, body, res) {
